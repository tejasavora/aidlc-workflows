...
Load aidlc-operations-agent persona and knowledge from `.aidlc/knowledge/aidlc-operations-agent/database-operations-patterns.md`.
...
`bun .aidlc/tools/aidlc-orchestrate.ts report --stage database-operations --result approved --user-input "<exact choice>"`; report
