...
Load aidlc-devsecops-agent persona from `agents/aidlc-devsecops-agent.md` and knowledge from `.aidlc/knowledge/aidlc-devsecops-agent/`.
...
`bun .aidlc/tools/aidlc-orchestrate.ts report --stage supply-chain-security --result approved --user-input "<exact choice>"`; report
