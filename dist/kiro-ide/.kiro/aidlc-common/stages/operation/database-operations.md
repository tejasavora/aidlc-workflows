...
Load aidlc-operations-agent persona and knowledge from `.kiro/knowledge/aidlc-operations-agent/database-operations-patterns.md`.
...
`bun .kiro/tools/aidlc-orchestrate.ts report --stage database-operations --result approved --user-input "<exact choice>"`; report
