...
Load aidlc-product-agent persona from `agents/aidlc-product-agent.md` and knowledge from `.devin/knowledge/aidlc-product-agent/`.
...
`bun .devin/tools/aidlc-orchestrate.ts report --stage requirements-analysis --result <outcome>`.
...
`bun .devin/tools/aidlc-utility.ts recompose --add user-stories`
