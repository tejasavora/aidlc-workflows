...
Load aidlc-operations-agent persona from `agents/aidlc-operations-agent.md` and knowledge from `.devin/knowledge/aidlc-operations-agent/`.
...
`bun .devin/tools/aidlc-orchestrate.ts report --stage feedback-optimization --result <outcome>`.
