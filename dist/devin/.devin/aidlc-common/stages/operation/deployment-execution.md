...
Load aidlc-pipeline-deploy-agent persona from `agents/aidlc-pipeline-deploy-agent.md` and knowledge from `.devin/knowledge/aidlc-pipeline-deploy-agent/`.
...
`bun .devin/tools/aidlc-orchestrate.ts report --stage deployment-execution --result <outcome>`.
