...
Load aidlc-aws-platform-agent persona from `agents/aidlc-aws-platform-agent.md` and knowledge from `.devin/knowledge/aidlc-aws-platform-agent/`.
...
`bun .devin/tools/aidlc-orchestrate.ts report --stage environment-provisioning --result <outcome>`.
