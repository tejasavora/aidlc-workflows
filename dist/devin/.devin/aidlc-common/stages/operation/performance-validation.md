...
Load aidlc-quality-agent persona from `agents/aidlc-quality-agent.md` and knowledge from `.devin/knowledge/aidlc-quality-agent/`.
...
`bun .devin/tools/aidlc-orchestrate.ts report --stage performance-validation --result <outcome>`.
