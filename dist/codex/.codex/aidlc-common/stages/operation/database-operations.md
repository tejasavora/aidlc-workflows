...
Load aidlc-operations-agent persona and knowledge from `.codex/knowledge/aidlc-operations-agent/database-operations-patterns.md`.
...
`bun .codex/tools/aidlc-orchestrate.ts report --stage database-operations --result approved --user-input "<exact choice>"`; report
