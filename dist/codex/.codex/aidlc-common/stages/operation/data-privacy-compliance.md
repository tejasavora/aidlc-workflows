...
Load aidlc-compliance-agent persona from `agents/aidlc-compliance-agent.md` and knowledge from `.codex/knowledge/aidlc-compliance-agent/`.
...
`bun .codex/tools/aidlc-orchestrate.ts report --stage data-privacy-compliance --result approved --user-input "<exact choice>"`; report
