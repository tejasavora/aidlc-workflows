---
name: aidlc-deployment-design
description: |
  Design the CI/CD pipeline, environment promotion gates, and rollback strategy.
  Tool-agnostic: generates pipeline configuration for GitHub Actions, GitLab CI,
  CodePipeline, ArgoCD, Jenkins, or any configured CI/CD system.
metadata:
  phase: operations
  stage: deployment-design
  per-unit: "false"
