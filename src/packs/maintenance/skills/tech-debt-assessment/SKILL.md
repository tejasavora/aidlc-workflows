...
description: |
  Quantify technical debt. Identify: complexity hotspots, outdated patterns, missing
  tests, stale dependencies, architecture drift. Produce prioritised remediation plan.
  Advisory only — no auto-fixes. human-clarification: true, artefact-verification: true.
metadata:
  phase: maintenance
  stage: tech-debt-assessment
  per-unit: "false"
