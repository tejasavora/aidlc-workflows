...
description: |
  Design high availability architecture: Multi-AZ/region layout, failover strategy,
  health checks, and auto-scaling. Produces HA design document and annotated
  infrastructure topology. Requires human confirmation of availability targets.
metadata:
  phase: construction
  stage: ha-design
  per-unit: "false"
