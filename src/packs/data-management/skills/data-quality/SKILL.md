---
name: aidlc-data-quality
description: |
  Validate data completeness, consistency, and format. Define quality rules from
  the domain model. Self-healing: quality check fails → clean/transform data → re-check.
  Tool-agnostic: Great Expectations, Deequ, custom SQL checks, or any.
metadata:
  phase: construction
  stage: data-quality
  per-unit: "true"
