...
description: |
  Generate synthetic test data or create masked production snapshots. Validates
  data integrity (referential constraints, business rules). Tool-agnostic:
  Faker, Factory Boy, custom generators, or production subsets.
metadata:
  phase: construction
  stage: data-seeding
  per-unit: "true"
