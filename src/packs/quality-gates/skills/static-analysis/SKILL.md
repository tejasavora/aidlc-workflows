...
description: |
  Run configured static analysis tools against generated code. Auto-fix lint/style issues.
  Escalate architectural concerns. Self-healing loop: run → diagnose → fix → re-run.
metadata:
  phase: construction
