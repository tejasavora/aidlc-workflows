...
description: |
  Compile code, run unit and integration tests. Self-healing loop: diagnose test failures,
  determine if test is wrong or code is wrong (by checking against design), fix, re-run.
metadata:
  phase: construction
