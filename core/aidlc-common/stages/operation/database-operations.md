...
Load aidlc-operations-agent persona and knowledge from `{{HARNESS_DIR}}/knowledge/aidlc-operations-agent/database-operations-patterns.md`.
...
`bun {{HARNESS_DIR}}/tools/aidlc-orchestrate.ts report --stage database-operations --result approved --user-input "<exact choice>"`; report
